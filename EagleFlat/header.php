<!DOCTYPE html>
<?php /* 
mods:  25Nov15 zig - add GTM function after body tag
       3May16 zig - playing with site title display
*/ ?>
				...
				<div class="large-12 columns header-container">
					...
					<div id="logo" class="logo-left">
						<a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?> - <?php bloginfo( 'description' ); ?>" rel="home">
							...
							} else {/* bloginfo( 'name' ); zig */ echo "<div class='logo-name'>Eagle’s Lodge</div><div class='logo-second'>Motel</div>"; }?>
						</a>
					</div><!-- .logo -->
					<?php endif; ?>
					...
					<div id="logo" class="logo-center">
						<a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?> - <?php bloginfo( 'description' ); ?>" rel="home">
							...
							} else { /* zig bloginfo( 'name' ); */ echo "<div class='logo-name'>Eagle’s Lodge</div><div class='logo-second'>Motel</div>"; }?>
						</a>
					</div><!-- .logo -->
					<?php } ?>
